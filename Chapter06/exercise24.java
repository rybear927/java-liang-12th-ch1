...
public class exercise24 {
    ...
    public static void showCurrentTime() {
        ...
        // get current year
        printCurrentYearAndDay(totalHours);
    ...
    public static void printCurrentYearAndDay(long totalHours) {
        ...
        currentDay--;
        System.out.print("It is currently " + getMonthName(currentMonth) + " " + currentDay + ", " + currentYear + " and" +
                " the ");
