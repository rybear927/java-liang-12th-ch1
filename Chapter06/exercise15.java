...
//Hint: round the tax into integers using Math.round (i.e., Math.round(computeTax(status, taxable Income))).

public class exercise15 {
    //Note: some of my calculations are off here. I'm not going back to chapter 3, exercise 13 to fix them.
    //I doubt it matters in the long run, but it's annoying enough that I put a note here.
